	...
	<div class="container">
		...
		<!-- heading -->
			<div class="single-head">
				<!-- Heading -->
				<h3 class="pull-left"><i class="fa fa-credit-card red"></i>Employee Detail</h3>
                                    ...
                                    <table class="table table-bordered">
                                        <tr>
                                        	<td class="active col-sm-6"><strong>First Name</strong></td>
                                          	<td><strong>{{ucfirst($emp->employee->firstname) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Middle Name</strong></td>
                                          	<td><strong>{{ucfirst($emp->employee->middlename) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Last Name</strong></td>
                                          	<td><strong>{{ucfirst($emp->employee->lastname) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Father's Name</strong></td>
                                          	<td><strong>{{ucfirst($emp->employee->fathername) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Date of birth</strong></td>
                                          	<td><strong>{{ Implode('/',array_reverse(explode('-',$emp->employee->dateofbirth))) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Maritial Staus</strong></td>
                                          	<td><strong>{{ucfirst($emp->employee->maritialstatus) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Spouse Name</strong></td>
                                          	<td><strong>{{ucfirst($emp->employee->spousename) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Siblings Under 18</strong></td>
                                          	<td><strong>{{ucfirst($emp->employee->sibling) }}</strong></td>
                                    	</tr>
                                        <tr>
                                            <td class="active"><strong>Mother maiden name</strong></td>
                                            <td><strong>{{ucfirst($emp->employee->mothermaiden) }}</strong></td>
                                        </tr>
                                        <tr>
                                            <td class="active"><strong>BloodGroup</strong></td>
                                            <td><strong>{{ucfirst($emp->employee->bloodgroup) }}</strong></td>
                                        </tr>
                                    </table>
                                </div><!-- end profile details -->
                                <div class="col-sm-offset-1 col-md-3 col-sm-3 text-center">
									<!-- Profile pic -->
                                    <a href="#">{{ $emp->employee->image ? HTML::image('public/img/emp/photo/'.$emp->employee->image,'', array('class'=>'img-thumbnail  img-responsive','style'=>'width:230px;height:240px')) : HTML::image('public/img/bhoopal.jpg','', array('class'=>'img-thumnail img-circle img-responsive','style'=>'height:300px')) }}</a>
                                    <hr>
                                    <a href="#">{{ $emp->employee->signature ? HTML::image('public/img/emp/sign/'.$emp->employee->signature,'', array('class'=>'img-thumbnail img-responsive','style'=>'width:230px;height:60px')) : HTML::image('public/img/bhoopal.jpg','', array('class'=>'img-thumnail img-responsive','style'=>'width:250px;height:70px')) }}</a>
                                    <h2>Signature</h2>
                                </div><!-- end profile pic -->
                                    ...
                                    <table class="table table-bordered">
                                        <tr>
                                        	<td class="active" style="width:400px"><strong>Present Address</strong></td>
                                          	<td><strong>{{$emp->contact->address }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>City</strong></td>
                                          	<td><strong>{{ucfirst($emp->contact->city) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>State </strong></td>
                                          	<td><strong>{{ucfirst($emp->contact->state) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>PIN</strong></td>
                                          	<td><strong>{{ucfirst($emp->contact->pin) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Permanent Address</strong></td>
                                          	<td><strong>{{ $emp->contact->p_address }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>City</strong></td>
                                          	<td><strong>{{ucfirst($emp->contact->p_city) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>State</strong></td>
                                          	<td><strong>{{ucfirst($emp->contact->p_state) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>PIN</strong></td>
                                          	<td><strong>{{ucfirst($emp->contact->p_pin) }}</strong></td>
                                    	</tr>
                                        <tr>
                                            <td class="active"><strong>Mobile No</strong></td>
                                            <td><strong>{{$emp->contact->mobile }}</strong></td>
                                        </tr>
                                        <tr>
                                            <td class="active"><strong>Phone No</strong></td>
                                            <td><strong>{{$emp->contact->phone }}</strong></td>
                                        </tr>
                                        <tr>
                                            <td class="active"><strong>Alt Mobile No</strong></td>
                                            <td><strong>{{$emp->contact->alt_mobile }}</strong></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>{{$emp->contact->alt_email }}</strong></td>
                                        </tr>
                                    </table>
                                </div><!-- end profile details -->
							</div><!-- end row -->
                                    ...
                                    <table class="table table-bordered">
                                        <tr>
                                        	<td class="active" style="width:400px"><strong>PAN</strong></td>
                                          	<td><strong>{{$emp->empIdentity->pan }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Passport No</strong></td>
                                          	<td><strong>{{$emp->empIdentity->passport_no or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Adhar No </strong></td>
                                          	<td><strong>{{$emp->empIdentity->adhar_no or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Voter ID No</strong></td>
                                          	<td><strong>{{$emp->empIdentity->voter_id or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Driving Licence No</strong></td>
                                          	<td><strong>{{$emp->empIdentity->driving_licence or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Bank Account No</strong></td>
                                          	<td><strong>{{$emp->empBankDetail->account_no or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Bank Name</strong></td>
                                          	<td><strong>{{$emp->empBankDetail->bank_name or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Branch Name</strong></td>
                                          	<td><strong>{{$emp->empBankDetail->branch or '' }}</strong></td>
                                    	</tr>
                                        <tr>
                                            <td class="active"><strong>IFSC</strong></td>
                                            <td><strong>{{$emp->empBankDetail->IFSC or '' }}</strong></td>
                                        </tr>
                                        <tr>
                                            <td class="active"><strong>MICR No</strong></td>
                                            <td><strong>{{$emp->empBankDetail->micrno or '' }}</strong></td>
                                        </tr>
                                    </table>
                                </div><!-- end profile details -->
							</div><!-- end row -->
                                    ...
                                    <table class="table table-bordered">
                                        <tr>
                                        	<td class="active" style="width:400px"><strong>Has PF</strong></td>
                                          	<td><strong>{{$emp->empPfEsi->isPF }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>PF NO</strong></td>
                                          	<td><strong>{{$emp->empPfEsi->pfno or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>PF Enrollment No </strong></td>
                                          	<td><strong>{{$emp->empPfEsi->pfenno or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>EPF No</strong></td>
                                          	<td><strong>{{$emp->empPfEsi->epfno or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Relationship to be specified</strong></td>
                                          	<td><strong>{{$emp->empPfEsi->relationship or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Employee has ESI</strong></td>
                                          	<td><strong>{{$emp->empPfEsi->isESI or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>ESI NO</strong></td>
                                          	<td><strong>{{$emp->empPfEsi->esino or '' }}</strong></td>
                                    	</tr>
                                    </table>
                                </div><!-- end profile details -->
							</div><!-- end row -->
                                    ...
                                    <table class="table table-bordered">
                                        <tr>
                                        	<td class="active" style="width:400px"><strong>Joining Date</strong></td>
                                          	<td><strong>{{Implode('/',array_reverse(explode('-',$emp->empJobDetail->joining_date))) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Job Type</strong></td>
                                          	<td><strong>{{ucfirst($emp->empJobDetail->job_type)}}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Designation </strong></td>
                                          	<td><strong>{{$emp->empJobDetail->designation or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Department</strong></td>
                                          	<td><strong>{{$emp->empJobDetail->dept->name or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Reporting Manager</strong></td>
                                          	<td><strong>{{$emp->empJobDetail->reporting_manager or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Payment Mode</strong></td>
                                          	<td><strong>{{$emp->empJobDetail->payment_mode or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>HR Verification</strong></td>
                                          	<td><strong>{{$emp->empJobDetail->hr_verification or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Police Verification</strong></td>
                                          	<td><strong>{{$emp->empJobDetail->police_verification or '' }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Employee Type</strong></td>
                                          	<td><strong>{{$emp->empJobDetail->emp_type or '' }}</strong></td>
                                    	</tr>
                                    	@if($emp->empJobDetail->emp_type == 'outsource')
                                    	<tr>
                                        	<td class="active"><strong>Company Name</strong></td>
                                          	<td><strong>{{$emp->empJobDetail->company->company_name or '' }}</strong></td>
                                    	</tr>
                                    	@endif
                                     </table>
                                </div><!-- end profile details -->
                                    ...
                                    <table class="table table-bordered">
                                        <tr>
                                        	<td class="active" style="width:400px"><strong>Salary</strong></td>
                                          	<td><strong>{{$emp->empJobDetail->ctc or ''}}</strong></td>
                                    	</tr>
                                    </table>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                        	<td class="active" style="width:400px"><strong>School Name</strong></td>
                                          	<td><strong>{{ucfirst($emp->empEducation->school_name) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>School Place</strong></td>
                                          	<td><strong>{{ucfirst($emp->empEducation->school_location) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Percentage </strong></td>
                                          	<td><strong>{{ucfirst($emp->empEducation->school_percentage) }}</strong></td>
                                    	</tr>
                                    	...
                                    	<tr>
                                        	<td class="active"><strong>Institution Name</strong></td>
                                          	<td><strong>{{ucfirst($emp->empEducation->puc_name) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Place</strong></td>
                                          	<td><strong>{{ ucfirst($emp->empEducation->puc_location) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Percentage</strong></td>
                                          	<td><strong>{{ucfirst($emp->empEducation->puc_percentage) }}</strong></td>
                                    	</tr>
                                    	<tr><td colspan="2" class="active"><span class="col-sm-offset-5"><strong>Diploma</strong></span></td></tr>
                                    	<tr>
                                        	<td class="active"><strong>Institution Name</strong></td>
                                          	<td><strong>{{ucfirst($emp->empEducation->diploma_name) }}</strong></td>
                                    	</tr>
                                    	<tr>
                                        	<td class="active"><strong>Place</strong></td>
                                          	<td><strong>{{ucfirst($emp->empEducation->diploma_location) }}</strong></td>
                                    	</tr>
                                        <tr>
                                            <td class="active"><strong>Percentage</strong></td>
                                            <td><strong>{{$emp->empEducation->diploma_percentage }}</strong></td>
                                        </tr>
                                        <tr><td colspan="2" class="active"><span class="col-sm-offset-5"><strong>Degree</strong></span></td></tr>
                                        <tr>
                                            <td class="active"><strong>Institution Name</strong></td>
                                            <td><strong>{{$emp->empEducation->degree_name }}</strong></td>
                                        </tr>
                                        <tr>
                                            <td class="active"><strong>Place</strong></td>
                                            <td><strong>{{$emp->empEducation->degree_location }}</strong></td>
                                        </tr>
                                        <tr>
                                            <td class="active"><strong>Percentage</strong></td>
                                            <td><strong>{{$emp->empEducation->degree_percentage }}</strong></td>
                                        </tr>
                                        <tr><td colspan="2" class="active"><span class="col-sm-offset-5"><strong>Master</strong> Degree</span></td></tr>
                                        <tr>
                                            <td class="active"><strong>Institution Name</strong></td>
                                            <td><strong>{{$emp->empEducation->master_name }}</strong></td>
                                        </tr>
                                        <tr>
                                            <td class="active"><strong>Place</strong></td>
                                            <td><strong>{{$emp->empEducation->master_location }}</strong></td>
                                        </tr>
                                        <tr>
                                            <td class="active"><strong>Percentage</strong></td>
                                            <td><strong>{{$emp->empEducation->master_percentage }}</strong></td>
                                        </tr>
