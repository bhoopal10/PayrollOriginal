	...
	<div class="container">
		...
		<!-- heading -->
			<div class="single-head">
				<!-- Heading -->
				<h3 class="pull-left"><i class="fa fa-credit-card red"></i>About Me</h3>
					...
					<div class="tab-content">
							...
							<div class="row">
								<div class="col-md-9 col-sm-9">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                        	<td class="active" style="width:400px"><strong>SchoolName</strong></td>
                                        ...
                                        <tr><td colspan="2" class="active"><span class="col-sm-offset-5"><strong>Master Degree</strong></span> </td></tr>
                                        <tr>
                                            <td class="active"><strong>Institution Name</strong></td>
						...
						<h4>Document detail </h4>
							...
							<div class="row">
								...
								<div class="col-lg-9">
									{{ HTML::image('public/img/emp/doc/'.$doc->document,'',array('style'=>"width:500px;height:500px"))}}
								</div>
							</div>
